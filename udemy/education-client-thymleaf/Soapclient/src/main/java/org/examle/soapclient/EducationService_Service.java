 ...
 * 
 */
@WebServiceClient(name = "EducationService", targetNamespace = "http://ws.SoapService.soapservice.example.org/", wsdlLocation = "http://localhost:8082/education?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EDUCATIONSERVICE_QNAME = new QName("http://ws.SoapService.soapservice.example.org/", "EducationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/education?wsdl");
    ...
    public EducationService getEducationServicePort() {
        return super.getPort(new QName("http://ws.SoapService.soapservice.example.org/", "EducationServicePort"), EducationService.class);
    }
    ...
    public EducationService getEducationServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.SoapService.soapservice.example.org/", "EducationServicePort"), EducationService.class, features);
    }
